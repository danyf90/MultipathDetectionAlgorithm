<form class="content entity" id="worker">
    ...
    <table>
        <thead>
            <tr><th id="loading"><img src="/images/loading.gif" />Loading...</th><td><h2><input id="worker-name" placeholder="Insert a name..." type="text" /></h2></td></tr>
        </thead>
        <tbody id="worker-table-body">
            ...
            <tr><th>Ruolo</th><td><input id="worker-role" type="text" placeholder="Insert the roles..."/></td></tr>
        </tbody>
    </table>
