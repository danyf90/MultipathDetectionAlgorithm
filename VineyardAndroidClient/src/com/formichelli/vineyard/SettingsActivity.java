...
public class SettingsActivity extends PreferenceActivity 
	...
	private enum Validity {
		VALID,
		NOT_VALID_SERVER_URL,
		NOT_VALID_SERVER_PORT,
	}
	...
	protected Validity isValid(SharedPreferences sharedPreferences) {
		...
		serverURL = sharedPreferences.getString(getString(
				R.string.preference_server_url), null);

		try {
			serverPort = Integer.parseInt(sharedPreferences.getString(getString(
					R.string.preference_server_port), "-1"));
	...
	OnMenuItemClickListener restoreSettings = new OnMenuItemClickListener() {
		...
		private void showConfirmDialog() {
            DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int which) {
                         ...
                         case DialogInterface.BUTTON_POSITIVE:
                                Toast.makeText(SettingsActivity.this, R.string.preference_settings_restored,
            ...
            (new AlertDialog.Builder(SettingsActivity.this))
	            ...
	            .setPositiveButton(R.string.preference_settings_restore_confirm, dialogClickListener)
	            .setNegativeButton(R.string.preference_settings_restore_cancel, dialogClickListener).show();
     	}
